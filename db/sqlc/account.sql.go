...
const updateAcount = `-- name: UpdateAcount :exec
UPDATE accounts
SET balance = $2
WHERE id = $1
`
...
func (q *Queries) UpdateAcount(ctx context.Context, arg UpdateAcountParams) error {
	_, err := q.db.ExecContext(ctx, updateAcount, arg.ID, arg.Balance)
	return err
}
